...
public class Preferencias {
    ...
    private static Preferencias prefsInstance;
    ...
    private Preferencias(Context context, String preferencesName) {
        sharedPreferences = context.getApplicationContext().getSharedPreferences(
                preferencesName,
                Context.MODE_PRIVATE
        );
    ...
    public static Preferencias with(Context context) {
        if (prefsInstance == null) {
            prefsInstance = new Preferencias(context);
        }
        return prefsInstance;
    }

    public static Preferencias with(Context context, boolean forceInstantiation) {
    ...
    public static Preferencias with(Context context, String preferencesName) {
        if (prefsInstance == null) {
            prefsInstance = new Preferencias(context, preferencesName);
        }
        return prefsInstance;
    }
